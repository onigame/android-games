...
public class NotesDbAdapter {
    ...
    public long addData(Bundle b) {
      String pid = b.getString(ScoreList.ScoreColumns.PUZZLE_ID);
      String score = b.getString(ScoreList.ScoreColumns.SCORE);
      String summary = "Puzzle ID: " + pid + " Moves: " + score;
      ContentValues initialValues = new ContentValues();
      initialValues.put(KEY_TITLE, summary);
      initialValues.put(KEY_BODY, summary);
      return mDb.insert(DATABASE_TABLE, null, initialValues);
    }
}
